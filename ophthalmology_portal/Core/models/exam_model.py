...
class ExamModel(models.Model):
    ...
    visual_accuity_unaided_string_right_near = encrypt(
        models.CharField(max_length=255, null=True, blank=True, default="Not Recorded")
    )
    visual_accuity_unaided_string_left_near = encrypt(
        models.CharField(max_length=255, null=True, blank=True, default="Not Recorded")
    )
    visual_accuity_unaided_string_both_near = encrypt(
        models.CharField(max_length=255, null=True, blank=True, default="Not Recorded")
    )
    visual_accuity_aided_string_right_near = encrypt(
        models.CharField(max_length=255, null=True, blank=True, default="Not Recorded")
    )
    visual_accuity_aided_string_left_near = encrypt(
        models.CharField(max_length=255, null=True, blank=True, default="Not Recorded")
    )
    visual_accuity_aided_string_both_near = encrypt(
        models.CharField(max_length=255, null=True, blank=True, default="Not Recorded")
    )

    visual_accuity_unaided_string_right_distance = encrypt(
        models.CharField(max_length=255, null=True, blank=True, default="Not Recorded")
    )
    visual_accuity_unaided_string_left_distance = encrypt(
        models.CharField(max_length=255, null=True, blank=True, default="Not Recorded")
    )
    visual_accuity_unaided_string_both_distance = encrypt(
        models.CharField(max_length=255, null=True, blank=True, default="Not Recorded")
    )
    visual_accuity_aided_string_right_distance = encrypt(
        models.CharField(max_length=255, null=True, blank=True, default="Not Recorded")
    )
    visual_accuity_aided_string_left_distance = encrypt(
        models.CharField(max_length=255, null=True, blank=True, default="Not Recorded")
    )
    visual_accuity_aided_string_both_distance = encrypt(
        models.CharField(max_length=255, null=True, blank=True, default="Not Recorded")
    )
    ...
    def aided_string_distance(self):
        ...
        if accuity.visual_acuity_measure_right and pinhole.visual_acuity_measure_right:
            ...
            self.visual_accuity_aided_string_right_distance = (
                f"DccOD {accuity.visual_acuity_measure_right}"
            )
        if accuity.visual_acuity_measure_left and pinhole.visual_acuity_measure_left:
            ...
            self.visual_accuity_aided_string_left_distance = (
                f"DccOS {accuity.visual_acuity_measure_left}"
            )
        if accuity.visual_acuity_measure_both and pinhole.visual_acuity_measure_both:
            ...
            self.visual_accuity_aided_string_both_distance = (
                f"DccOU {accuity.visual_acuity_measure_both}"
            )
    ...
    def postexam(self):
        if (
            self.occular_exam_information
            and self.prescription
            and (
                self.visual_accuity_unaided_near
                or self.visual_accuity_aided_near
                or self.visual_accuity_aided_distance
                or self.visual_accuity_unaided_distance
            )
        ):
